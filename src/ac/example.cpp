...
int main() {
    std::cout << "\n=== Aho-Corasick String Matcher Example ===\n\n";
    ...
    std::cout << "\nCompiling Aho-Corasick engine...\n";
    std::cout << "SUCCESS: Aho-Corasick matcher is ready!\n";
    ...
    std::cout << "\n=== Summary ===\n\n";
    std::cout << "Successfully compiled and executed Aho-Corasick string matcher!\n";
    std::cout << "The AC engine scanned " << text.length() << " bytes and found " 
              << match_count << " matches.\n";
    std::cout << "\nNote: This is a simplified example. Full AC requires Snort3 integration.\n";
