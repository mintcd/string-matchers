/*
 * AC String Matcher - Main Application
 * 
 * This application demonstrates the AC matcher with:
...
// Simple AC-style search (using basic string matching)
...
int main(int argc, char *argv[]) {
    cout << "=== AC String Matcher Application ===" << endl << endl;
    ...
    cout << "SUCCESS: AC engine compiled in " << compile_time << " ms" << endl;
    cout << endl;
