...
\begin{align*}
  \PP(B)
   & = 1-\PP\left(\bigcup_{j=1}^8 E_j\right)                                                                                                                                         \\
   & = 1-\sum_{\varnothing\ne L \subset \{0\ldots 7\}} (-1)^{|L|+1}\PP\left(\bigcap_{j\in L} E_j\right)                                                                              \\
   & = 1+\sum_{\varnothing\ne L \subset \{0\ldots 7\}} (-1)^{|L|}\PP\left(\bigcap_{j=1}^8\bigcap_{i=1}^p \{X_i\notin S_j\}\right)                                                    \\
...
I think we can elaborate more to count the number of subsets $L$ having $v_i$ clusters of size $i$ for $i\in\{1,\ldots, 7\}$. I am not sure if I can get an asymptotic approximation to compare with the case without super-characters.
